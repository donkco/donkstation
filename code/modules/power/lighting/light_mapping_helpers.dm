...
// ---- Burned tube
WALL_MOUNT_DIRECTIONAL_HELPERS(/obj/machinery/light/burned)

// ---- Tube construct
WALL_MOUNT_DIRECTIONAL_HELPERS(/obj/structure/light_construct)

// ---- Tube frames
WALL_MOUNT_DIRECTIONAL_HELPERS(/obj/machinery/light/empty)
...
// ---- Bulb frames
WALL_MOUNT_DIRECTIONAL_HELPERS(/obj/machinery/light/small/empty)

// ---- Broken bulbs
WALL_MOUNT_DIRECTIONAL_HELPERS(/obj/machinery/light/small/broken)

// ---- Burned bulb
WALL_MOUNT_DIRECTIONAL_HELPERS(/obj/machinery/light/small/burned)
