...
/datum/preferences/proc/load_character(slot)
	...
	//Job Slate
	job_slate = save_data?["job_slate"]
	overflow_char_slot = save_data?["overflow_char_slot"]
...
/datum/preferences/proc/save_character()
	...
	//Job Slate
	save_data["job_slate"] = job_slate
	save_data["overflow_char_slot"] = overflow_char_slot
