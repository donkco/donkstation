...
#define BODYSHAPE_FAT_TORSO (1 << 5)
#define BODYSHAPE_FAT_LEGS (1 << 6)
#define BODYSHAPE_BOOBIES (1 << 7)
#define BODYSHAPE_FEMININE_HIPS (1 << 8)
...
#define SPECIES_ANDROIDMONKEY "androidmonkey"
