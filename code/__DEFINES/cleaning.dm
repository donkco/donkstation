...
/// Cleans soil samples off of the cleanable atom
#define CLEAN_TYPE_SOIL (1 << 8)
...
#define CLEAN_SCRUB (CLEAN_WASH | CLEAN_TYPE_FINGERPRINTS | CLEAN_TYPE_FIBERS | CLEAN_TYPE_SOIL | CLEAN_TYPE_HARD_DECAL)
