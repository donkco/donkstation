...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	...
	new/datum/stack_recipe("concrete platform mould", /obj/structure/concrete_mould/platform, 5, time = 5 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, category = CAT_CONCRETE_MOULDS), \
	new/datum/stack_recipe("concrete ramp mould (south)", /obj/structure/concrete_mould/ramp, 2, time = 3 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, category = CAT_CONCRETE_MOULDS), \
	new/datum/stack_recipe("concrete ramp mould (north)", /obj/structure/concrete_mould/ramp/north, 2, time = 3 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, category = CAT_CONCRETE_MOULDS), \
	new/datum/stack_recipe("concrete ramp mould (east)", /obj/structure/concrete_mould/ramp/east, 2, time = 3 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, category = CAT_CONCRETE_MOULDS), \
	new/datum/stack_recipe("concrete ramp mould (west)", /obj/structure/concrete_mould/ramp/west, 2, time = 3 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, category = CAT_CONCRETE_MOULDS), \
	new/datum/stack_recipe("concrete sow mould", /obj/structure/concrete_mould/concrete_sow, 3, time = 3 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, category = CAT_CONCRETE_MOULDS), \
...
GLOBAL_LIST_INIT(plastic_recipes, list(
	...
	new /datum/stack_recipe("plastic table frame", /obj/structure/table_frame/plastic, 2, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, time = 1 SECONDS, category = CAT_FURNITURE), \
