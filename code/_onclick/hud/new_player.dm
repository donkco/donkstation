...
/datum/hud/new_player/New(mob/owner)
	...
	for(var/i in 1 to 5)
		...
		add_screen_object(slot_button)
		slot_buttons += slot_button
...
/datum/hud/new_player/proc/do_build_slot_previews()
	...
	if(!owner_client)
		return
	for(var/atom/movable/screen/lobby/button/character_slot/slot_button in slot_buttons)
