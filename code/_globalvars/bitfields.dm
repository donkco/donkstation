...
DEFINE_BITFIELD(supports_variations_flags, list(
	"CLOTHING_DIGI_TAILORED" = CLOTHING_DIGI_TAILORED,
	"CLOTHING_DIGI_FRIENDLY" = CLOTHING_DIGI_FRIENDLY,
	"CLOTHING_DIGITIGRADE_MASK" = CLOTHING_DIGITIGRADE_MASK,
	"CLOTHING_FEMALE_TAILORED" = CLOTHING_FEMALE_TAILORED,
	"CLOTHING_FEMALE_FILTER" = CLOTHING_FEMALE_FILTER,
	"CLOTHING_FEMALE_FRIENDLY" = CLOTHING_FEMALE_FRIENDLY,
	"CLOTHING_FAT_TAILORED" = CLOTHING_FAT_TAILORED,
	"CLOTHING_FAT_FRIENDLY" = CLOTHING_FAT_FRIENDLY,
))
